<html>
  ...
  <body>
    ...
    <?php
    $sql = 'SELECT * FROM CARACTERISTIQUE_NUTRITIONELLE;';
    $reponse = mysql_query ($sql) or die ('Erreur SQL !'.$sql.'<br/>'.mysql_error());   
       ?>
    <table>
      <tr>
	 ...
	 ?>
      <tr>
        <th><?php echo $donnees['NUMERO_CARACTERISTIQUE_NUTRITIONELLE'];?></th>
        <th><?php echo $donnees['NOM_CARACTERISTIQUE_NUTRITIONELLE'];?></th>
      </tr>
