...
<body>
  ...
  if (isset ($_POST['consulter_cal'])){
    ...
    $sql_date = 'SELECT distinct NOM_RECETTE from RECETTE R, CONTENU C, INGREDIENT I, DEFINITION D
    WHERE R.NUMERO_RECETTE=C.NUMERO_RECETTE AND C.NUMERO_INGREDIENT=I.NUMERO_INGREDIENT AND I.NUMERO_INGREDIENT=D.NUMERO_INGREDIENT AND D.VALEUR<='.$calorie.';';
